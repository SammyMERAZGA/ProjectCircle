          ...
          <v-container fluid>
            <v-row>
              ...
              <p class="body-2 mb-10 ml-15 mr-15">
                ...
                revoir…
                Qui sont nos clients ? Quelles sont nos ressources actuelles ? Comment faire ?
                <br><br>
                Votre seule option pour vous sortir de cette situation c’est le Business Modèle Canvas.
                Vous pourrez aller aider le pôle suivant une fois qu’il sera établi.
              </p>
            </v-row>
          </v-container>
        </v-tab-item>
          ...
          <v-container fluid>
            <v-row>
              ...
              <p class="body-2 mb-10 ml-15 mr-15">
                ...
                d’activité ou la taille de votre marché, votre projet peut se résumer en un tableau simple, accessible
                et compréhensible pour tous.
                Le principe du BMC repose sur 9 blocs qui couvrent les 4 dimensions fondamentales de quelconque
                (qui – quoi – comment – combien). Les 9 blocs permettent de décrire, inventer, tester et dessiner le
                ...
                travail
                (partenaires, ressources, activités) tandis que la partie droite précise pour qui vous créez de la
                valeur
                (quels clients, quelles relations, quelle distribution). Enfin, la partie inférieure du tableau met en
                avant
                votre structure de coûts et vos flux de revenus.
              </p>
            </v-row>
          </v-container>
        </v-tab-item>
