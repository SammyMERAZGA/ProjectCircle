      ...
      <Transition>
        ...
        >
          ...
          <v-stepper-content step="1">
            ...
            <v-row align="center" justify="center" class="mb-2">
              <v-btn class="rounded-xl mr-2" @click="changeCard(2, false)">
                Coder sur un même ordinateur
              </v-btn>
              <v-btn class="rounded-xl ml-2" @click="changeCard(2, true)">
                Utiliser git
              </v-btn>
            </v-row>
          </v-stepper-content>
          ...
          <v-stepper-content step="2">
            <p class="body-2 mb-5 ml-5 mr-5">
              DMhh… Coder à plusieurs via git semble être une bonne solution,
              Connaissez-vous le versioning ?
            </p>
            <p class="body-2 mb-5 ml-5 mr-5">
            ...
            <v-row align="center" justify="center" class="mb-2">
              ...
              <v-btn class="rounded-xl ml-2" @click="changeCard(3, false)">
          ...
          <v-stepper-content step="3">
            <p class="body-2 mb-5 ml-5 mr-5">
              ...
              sur votre projet ainsi que vos fichiers. Créé les branches pour
            ...
            <p class="body-2 mb-5 ml-5 mr-5">
              ...
              ! Quelle commande utiliser selon vous ?
            </p>
            <v-row align="center" justify="center" class="mb-2">
              <v-btn class="rounded-xl mr-2" @click="changeCard(4, true)">
                Git add</v-btn
              >
              <v-btn class="rounded-xl ml-2" @click="changeCard(4, false)"
                >Git commit</v-btn
              >
            </v-row>
          </v-stepper-content>
          ...
          <v-stepper-content step="4">
            <p class="body-2 mb-5 ml-5 mr-5">
              Et oui ! Avant même de comit il faut savoir quel fichiers nous
              voulons pousser vers le rpository, utiliser git add nom_fichier
              pour prendre en compte la modification du fichier.
            </p>
            <p class="body-2 mb-5 ml-5 mr-5">
              Et maintenant vous pouvez faire votre premier commit : git commit
              -m "message du commit". Une fois les commits réalisés, il faut
              maintenant pousser les développements :
            </p>
            <v-row align="center" justify="center" class="mb-2">
              <v-btn class="rounded-xl mr-2" @click="changeCard(5, false)">
                Utiliser git pushed
              </v-btn>
              <v-btn class="rounded-xl ml-2" @click="changeCard(5, true)">
                Utiliser git push
              </v-btn>
            </v-row>
          </v-stepper-content>
          ...
          <v-stepper-content step="5">
            ...
            <p class="body-2 mb-5 ml-5 mr-5">
              Le merge vas vous permettre de fusionner le code.
            </p>
            <v-row align="center" justify="center" class="mb-2">
              <v-btn class="rounded-xl mr-2" @click="changeCard(6, true)">
                Utiliser git merge
              </v-btn>
              <v-btn class="rounded-xl ml-2" @click="changeCard(6, false)">
                Utiliser git fusion
              </v-btn>
            </v-row>
          </v-stepper-content>
