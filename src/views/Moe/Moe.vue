      ...
      <template @click.stop="dialogPresentation = false">
        <v-card class="rounded-lg" height="600">
          <v-toolbar color="teal darken-2" dark
            ...
            ></v-toolbar
          >
          <v-img class="rounded-lg ma-3" src="@/assets/gif/contexteMOE.gif" />
      ...
      <Transition>
        ...
        >
          ...
          <v-stepper-content step="2">
            <p class="body-2 mb-5 ml-5 mr-5">
              Mmh… Coder à plusieurs via Git semble être une bonne solution.
          ...
          <v-stepper-content step="4">
            <p class="body-2 mb-5 ml-5 mr-5">
              Et oui ! Avant même de commit, il faut savoir quels fichiers nous
              voulons pousser vers le repository, utiliser git add nom_fichier
