      ...
      <v-tabs fixed-tabs background-color="teal darken-2" dark>
        ...
        <v-tab-item>
          <v-container fluid>
            <v-row>
              <v-col md="3">
                <v-img src="@/assets/resp-RH_.png" max-width="250"></v-img>
              </v-col>
              <v-col md="8">
                ...
                <p class="body-2 mb-10 mr-15">
                  Il est chargé de satisfaire les besoins des clients en menant
                  à bien la livraison d’un produit de qualité. Il sert
                  d’interface entre l’équipe technique, l’équipe marketing et
                  les clients. Au sein de son groupe de travail, il est le
                  premier responsable de la conception du produit..
                </p>
              </v-col>
            </v-row>
          </v-container>
        </v-tab-item>
        <v-tab> Scrum master </v-tab>
        <v-tab-item>
          <v-container fluid>
            <v-row>
              <v-col md="3">
              ...
              <v-col md="8">
                ...
                <p class="body-2 mb-10 mr-15">
                  Le Scrum Master agit comme un facilitateur au sein de l’équipe
                  Scrum. Il est chargé d’établir la méthodologie Scrum et
                  d’aider ses membres à respecter les principes et pratiques
                  Scrum. Orienté vers les relations, il prend plaisir à aider
                  ses collègues à évoluer et à s’améliorer.
                </p>
              </v-col>
            </v-row>
          </v-container>
        </v-tab-item>
        <v-tab> Team member </v-tab>
        <v-tab-item>
          <v-container fluid>
            <v-row>
              <v-col md="3">
              ...
              <v-col md="8">
                ...
                <p class="body-2 mb-10 mr-15">
                  Cette équipe aux compétences variées a pour rôle de développer
                  le meilleur produit possible. Selon les organisations, elle
                  peut se composer de profils tels que : développeurs,
                  architectes, business analysts, testeurs, UX designers, etc.
                </p>
              </v-col>
            </v-row>
          </v-container>
      ...
      <v-card>
        ...
        <v-card-text>
          <v-row align="center" justify="center">
            ...
            <p class="text-center">
              Vous avez reçu 3 avertissements, vous prennez une sanction,
              retournez apprendre vos leçons !
            </p>
          </v-row>
        </v-card-text>
        <v-card-actions>
